...
// DUMMY: deliberately broken references to exercise the Antora docs check.
See also xref:workflow/workflow-run-configurations/this-page-does-not-exist.adoc[a page that does not exist].

include::partial$this-partial-does-not-exist.adoc[]
