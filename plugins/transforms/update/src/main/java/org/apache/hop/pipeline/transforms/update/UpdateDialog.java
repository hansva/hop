...
public class UpdateDialog extends BaseTransformDialog {
  ...
  public String open() {
    createShell(BaseMessages.getString(PKG, "UpdateDialog.Shell.Title"));
    ...
    // Connection line
    wConnection = addConnectionLine(shell, null, input.getConnection(), lsMod);
    ...
    ciKey[2] =
        new ColumnInfo(
            BaseMessages.getString(PKG, "UpdateDialog.ColumnInfo.StreamField1"),
            ColumnInfo.COLUMN_TYPE_CCOMBO,
            new String[] {""},
            false);
    ciKey[3] =
        new ColumnInfo(
            BaseMessages.getString(PKG, "UpdateDialog.ColumnInfo.StreamField2"),
            ColumnInfo.COLUMN_TYPE_CCOMBO,
            new String[] {""},
            false);
    ...
    ciReturn[1] =
        new ColumnInfo(
            BaseMessages.getString(PKG, "UpdateDialog.ColumnInfo.StreamField"),
            ColumnInfo.COLUMN_TYPE_CCOMBO,
            new String[] {""},
            false);
  ...
  private void getTableName() {
    ...
    if (databaseMeta != null) {
      if (log.isDebug()) {
        logDebug(
            BaseMessages.getString(PKG, "UpdateDialog.Log.LookingAtConnection")
  ...
  private void get() {
    try {
      ...
      new ErrorDialog(
          shell,
          BaseMessages.getString(PKG, "UpdateDialog.FailedToGetFields.DialogTitle"),
          BaseMessages.getString(PKG, "UpdateDialog.FailedToGetFields.DialogMessage"),
          ke);
    }
  }
  ...
  private void create() {
    try {
      ...
      TransformMeta transforminfo =
          new TransformMeta(
              BaseMessages.getString(PKG, "UpdateDialog.TransformMeta.Title"), name, info);
      ...
      new ErrorDialog(
          shell,
          BaseMessages.getString(PKG, "UpdateDialog.CouldNotBuildSQL.DialogTitle"),
          BaseMessages.getString(PKG, "UpdateDialog.CouldNotBuildSQL.DialogMessage"),
          ke);
    }
  }
          ...
          EnterSelectionDialog dialog =
              new EnterSelectionDialog(
                  ...
                  BaseMessages.getString(
                      PKG, "UpdateDialog.AvailableSchemas.Title", wConnection.getText()),
                  BaseMessages.getString(
