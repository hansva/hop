...
public class StringOperationsDialog extends BaseTransformDialog {
  ...
  @Override
  public String open() {
    createShell(BaseMessages.getString(PKG, "StringOperationsDialog.Shell.Title"));
  ...
  private void get() {
    try {
      ...
      new ErrorDialog(
          shell,
          BaseMessages.getString(PKG, "StringOperationsDialog.FailedToGetFields.DialogTitle"),
          BaseMessages.getString(PKG, "StringOperationsDialog.FailedToGetFields.DialogMessage"),
          ke);
    }
  }
}
