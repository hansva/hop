...
public class TableOutputDialog extends BaseTransformDialog {
  ...
  public String open() {
    ...
    wlDdlOptions = new Label(shell, SWT.RIGHT);
    ...
    wDdlOptionsToggle = new Button(shell, SWT.PUSH);
    ...
    wDdlOptionsComposite = new Composite(shell, SWT.NONE);
    ...
    if (!gotPreviousFields) {
      try {
        ...
        new ErrorDialog(
            ...
            BaseMessages.getString(PKG, "TableOutputDialog.FailedToGetFields.DialogMessage"),
            ke);
      }
  ...
  protected void isConnectionSupported() {
    ...
    if (!Utils.isEmpty(tableName)) {
      DatabaseMeta dbmeta = pipelineMeta.findDatabase(connectionName, variables);
    ...
    try {
      ...
      if (isValidRowMeta(prev)) {
        ...
        if (!sql.hasError()) {
          ...
          String text = BaseMessages.getString(PKG, ERROR_TITLE);
      ...
      new ErrorDialog(
          ...
          BaseMessages.getString(PKG, "TableOutputDialog.BuildSQLError.DialogMessage"),
          ke);
    }
  }
