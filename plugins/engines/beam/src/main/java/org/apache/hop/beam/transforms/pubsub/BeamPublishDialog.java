...
public class BeamPublishDialog extends BaseTransformDialog {
  ...
  @Override
  public String open() {
    createShell(BaseMessages.getString(PKG, "BeamPublishDialog.DialogTitle"));
    ...
    fdlTopic.top = new FormAttachment(wTransformName, margin);
