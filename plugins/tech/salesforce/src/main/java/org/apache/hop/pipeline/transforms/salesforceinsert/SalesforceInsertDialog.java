...
public class SalesforceInsertDialog extends SalesforceTransformDialog {
  ...
  @Override
  public String open() {
    createShell(BaseMessages.getString(PKG, "SalesforceInsertDialog.DialogTitle"));
  ...
  private void getUpdate() {
    try {
      ...
      new ErrorDialog(
          shell,
          BaseMessages.getString(PKG, "SalesforceInsertDialog.FailedToGetFields.DialogTitle"),
          BaseMessages.getString(PKG, "SalesforceInsertDialog.FailedToGetFields.DialogMessage"),
          ke);
    }
  }
  ...
  private void ok() {
    try {
      ...
      new ErrorDialog(
          shell,
          BaseMessages.getString(PKG, "SalesforceInsertDialog.ErrorValidateData.DialogTitle"),
          BaseMessages.getString(PKG, "SalesforceInsertDialog.ErrorValidateData.DialogMessage"),
          e);
    }
