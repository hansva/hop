...
public class GlobalMessageUtil {
  ...
  /**
   * Calls {@link #calculateString(String[], String, Object[], Class, String, boolean)} with the
   ...
   * defined by the the concatenation of the package names defined in {@code packageName} and @code
   * bundleName} (the first valid combination of {@code packageName} + {@code bundleName} wins),
  ...
  /**
   * Returns a {@link ResourceBundle} corresponding to the given {@link Locale} package and resource
   * class. Falls-back on the ROOT {@link Locale}, if the {@code fallbackOnRoot} flag is true and
  ...
  /**
   * A custom {@link ResourceBundle.Control} implementation that provides the desired fall-back
   * mechanism.
   */
